...
def run(driver, quartos):
    driver.get("https://www.wanorimoveis.com.br/imoveis/para-alugar/casa/guaratingueta?quartos=" + str(quartos) + "+&preco-de-locacao=1200~1800")
    ...
    with open('cache/wanor', 'w+') as file:
    ...
    for result in results:
        ...
        location = result.find_element(By.CSS_SELECTOR, '.card-with-buttons__footer h2')
